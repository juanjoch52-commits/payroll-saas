-- =============================================================================
-- MyJova — GLP-1: handle_new_user lee uses_subcontractors del signup
-- =============================================================================
-- La pregunta "¿Pagas a contratistas/subcontratistas?" del formulario de
-- inscripción activa el módulo desde el día uno (multitenant por flag: las
-- empresas normales lo dejan apagado y nunca lo ven; siempre se puede cambiar
-- en Settings → General).
-- Resto de la función idéntico a 20260501000027_handle_new_user_contractor.sql.
-- =============================================================================
