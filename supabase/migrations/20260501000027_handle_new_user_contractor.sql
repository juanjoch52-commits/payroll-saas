-- =============================================================================
-- MyJova — CTR-1c: handle_new_user vincula al contratista en el signup
-- =============================================================================
-- Cuando el invitado con rol 'contractor' completa el signup, además de crear
-- la membership hay que setear subcontractors.user_id (su login del portal).
-- El path de usuario EXISTENTE lo cubre acceptInvitation (server action).
