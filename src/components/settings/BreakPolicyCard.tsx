...
export function BreakPolicyCard({
  ...
  const dirty =
    minutes !== String(currentMinutes) || thresholdHours !== String(currentThresholdMinutes / 60)
  ...
  return (
    <div className="space-y-3">
      <div>
        <h2 className="text-lg font-semibold">Unpaid lunch break</h2>
        <p className="text-sm text-muted-foreground">
          Automatically deduct an unpaid lunch from shifts that reach the threshold. Short
          (half-day) shifts are not deducted, and employees can flag &quot;I didn&apos;t take a
          lunch&quot; at clock out for your review. Set 0 minutes to disable.
        </p>
      </div>
      ...
      <p className="text-xs text-muted-foreground">
        Example: 30 min when the shift reaches 6 h — a 4 h half day keeps its full hours.
