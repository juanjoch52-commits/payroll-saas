...
import { performClockIn } from '@/lib/time/clock'

// POST /api/v1/time/clock-in  (app móvil — Bearer JWT del empleado)
...
export async function POST(req: Request) {
  ...
  const res = await performClockIn(admin, {
    ...
    worksiteId: parsed.data.worksiteId ?? null,
